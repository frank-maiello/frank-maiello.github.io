...
<style>
    ...
    .fan-blade:hover::before {
        background: linear-gradient(135deg, 
            hsla(24, 45%, 40%, 1.0) 0%,
            hsla(24, 35%, 10%, 0.9) 50%,
            hsla(24, 15%, 10%, 0.7) 100%); 
    }
...
<svg style="position: absolute; width: 0; height: 0;">
    <defs>
        <clipPath id="rounded-trapezoid" clipPathUnits="objectBoundingBox">
            <path d="M 0.053,0.3 Q 0,0.3 0,0.34 L 0.027,0.74 Q 0.027,0.78 0.08,0.78 L 0.98,0.65 Q 1,0.65 1,0.61 L 1,0.39 Q 1,0.35 0.98,0.35 Z"/>
        </clipPath>
    </defs>
</svg>
...
<!-- Old content kept for reference but hidden -->
    ...
    <div class="fan-blade" data-blade="0">
        <div class="blade-content">
            <div class="blade-image">
                <a href="https://frank-maiello.github.io/boids.html" target="_blank">
                    <img src="https://frank-maiello.github.io/screen_boids.png" alt="Boids">
                </a>
            </div>
            <div class="blade-text">
                <div class="appTitle">B0IDS</div>
                <h3><br></h3>
                <div class="description">I'm Flyin' Here!</div>
                <div class="verbiage2"><br>Birds aren't real. They're a simulation based</div>
                <div class="verbiage2">on Craig Reynolds' 1986 Boids algorithm.</div>
                <div class="verbiage2">Each 'boid' sees only its neighbors, and then</div>
                <div class="verbiage2">follows simple rules.</div>
                <div class="blade-buttons">
                    <br>
                    <a href="https://github.com/frank-maiello/frank-maiello.github.io/blob/main/boids.html" target="_blank" class="button">Code</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="fan-blade" data-blade="1">
        <div class="blade-content">
            ...
            <div class="blade-text">
                ...
                <div class="verbiage2">Created with the help of Claude.</div>
                <div class="blade-buttons">
                    <br>
    ...
    <div class="fan-blade" data-blade="3">
        <div class="blade-content">
            ...
            <div class="blade-text">
                ...
                <h3><br></h3>
                <div class="description">Algorithmic Line 'Art'</div>
    ...
    <div class="fan-blade" data-blade="4">
        <div class="blade-content">
            <div class="blade-image">
